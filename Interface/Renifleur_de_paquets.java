 ...
 * @author afarid
 */
public class Renifleur_de_paquets extends javax.swing.JFrame {
static String x=""; 
   static boolean etat1,etat2;
    public Renifleur_de_paquets() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(650, 250, 140, 30);
        ...
        jCheckBox1.setBounds(140, 220, 370, 23);
        ...
        jCheckBox2.setBounds(140, 250, 330, 23);
        getContentPane().add(jSeparator9);
        jSeparator9.setBounds(20, 170, 1010, 10);
        getContentPane().add(jTextField1);
        jTextField1.setBounds(650, 190, 140, 30);

        jLabel2.setText("saisir le nombre de paquet que vous voulez affcher :");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(140, 190, 380, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         if(jCheckBox1.isSelected()&&jCheckBox2.isSelected()){
             x="snort -vde -n "+jTextField1.getText()+" -c  /etc/snort/snort.conf";}
         if(!jCheckBox1.isSelected()&&!jCheckBox2.isSelected()){
        x="snort -v -n "+jTextField1.getText()+" -c  /etc/snort/snort.conf"; }
          if(!jCheckBox1.isSelected()&&jCheckBox2.isSelected()){
        x="snort -ve -n "+jTextField1.getText()+" -c /etc/snort/snort.conf"; }
           if(jCheckBox1.isSelected()&&!jCheckBox2.isSelected()){
        x="snort -vd  -n "+jTextField1.getText()+" -c /etc/snort/snort.conf"; }
        try{
 ...
 Process p= Runtime.getRuntime().exec(x);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Renifleur_de_paquets.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Renifleur_de_paquets().setVisible(true);
            }
        });
    }
